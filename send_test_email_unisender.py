...
def send_test_email() -> None:
    ...
    #message["X-UNISENDER-GO"] = '{"track_links":0,"track_read":0}'
    # Удаляем лишние пробелы в JSON
    #json_params = '{"track_links":0,"track_read":0}'
    # Используем add_header
    #message.add_header("X-UNISENDER-GO", json_params)
    message.set_content(
